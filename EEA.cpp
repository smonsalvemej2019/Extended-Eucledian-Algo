...
// two numbers as well as t and s from the formula GCD(a,b) = sa+tb

//function prototype of the Extended Euclidean Algo void eealgo(int a, int b, int& t, int& s);
...
//Function definition of the Extended Euclidean Algo void eealgo(int a, int b, int& t, int& s) {
